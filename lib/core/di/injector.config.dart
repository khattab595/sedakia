...
import '../../src/home/presentation/bloc/home_bloc.dart' as _i15;
...
import '../../src/splash/data/repositories/splash_repo.dart' as _i14;
import '../../src/splash/domain/repositories/base_splash_repo.dart' as _i13;
import '../../src/splash/domain/use_cases/splash_usecase.dart' as _i16;
import '../../src/splash/presentation/bloc/splash_bloc.dart' as _i17;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i13.BaseSplashRepo>(
      () => _i14.SplashRepo(gh<_i12.SplashDatasource>()));
  gh.factory<_i15.HomeCubit>(() => _i15.HomeCubit(
        gh<_i8.HomeUseCase>(),
        gh<_i6.HomeRepo>(),
      ));
  gh.factory<_i16.SplashUseCase>(
      () => _i16.SplashUseCase(gh<_i13.BaseSplashRepo>()));
  gh.factory<_i17.SplashCubit>(
      () => _i17.SplashCubit(gh<_i16.SplashUseCase>()));
  return getIt;
}
