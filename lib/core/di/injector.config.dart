...
import '../../src/auth/presentation/bloc/auth_bloc.dart' as _i41;
import '../../src/auth/presentation/bloc/forgot_password_bloc.dart' as _i46;
...
import '../../src/categories/presentation/bloc/categories_bloc.dart' as _i44;
...
import '../../src/customers/presentation/bloc/customers_bloc.dart' as _i45;
...
import '../../src/home/presentation/bloc/home_bloc.dart' as _i47;
...
import '../../src/more/presentation/bloc/more_bloc.dart' as _i49;
...
import '../../src/product/presentation/bloc/product_bloc.dart' as _i48;
...
import '../../src/requests/presentation/details/bloc/request_details_bloc.dart'
    as _i50;
import '../../src/requests/presentation/view/bloc/requests_bloc.dart' as _i51;
...
import '../../src/settings/domain/use_cases/settings_use_cases.dart' as _i37;
import '../../src/settings/presentation/bloc/about_logeste_bloc.dart' as _i40;
import '../../src/splash/data/data_sources/splash_datasource.dart' as _i39;
import '../../src/splash/data/repositories/splash_repo.dart' as _i43;
import '../../src/splash/domain/repositories/base_splash_repo.dart' as _i42;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i37.SettingsUseCase>(
      () => _i37.SettingsUseCase(gh<_i35.SettingsRepo>()));
  await gh.factoryAsync<_i38.SharedPreferences>(
    () => injectionModule.prefs,
    preResolve: true,
  );
  gh.factory<_i39.SplashDatasource>(() => _i39.SplashDatasource(gh<_i4.Dio>()));
  gh.factory<_i40.AboutCubit>(
      () => _i40.AboutCubit(gh<_i37.SettingsUseCase>()));
  gh.factory<_i41.AuthCubit>(() => _i41.AuthCubit(gh<_i5.AuthRepo>()));
  gh.factory<_i42.BaseSplashRepo>(
      () => _i43.SplashRepo(gh<_i39.SplashDatasource>()));
  gh.factory<_i44.CategoriesBloc>(() => _i44.CategoriesBloc(
        gh<_i8.CategoriesRepo>(),
        gh<_i10.CategoriesUseCase>(),
      ));
  gh.factory<_i45.CustomersBloc>(() => _i45.CustomersBloc(
        gh<_i12.CustomersRepo>(),
        gh<_i14.CustomersUseCase>(),
      ));
  gh.factory<_i46.ForgotPasswordCubit>(() => _i46.ForgotPasswordCubit(
  ...
  gh.factory<_i50.RequestDetailsBloc>(() => _i50.RequestDetailsBloc(
        gh<_i33.RequestsUseCase>(),
        gh<_i31.RequestsRepo>(),
      ));
  gh.factory<_i51.RequestsBloc>(() => _i51.RequestsBloc(
        gh<_i33.RequestsUseCase>(),
        gh<_i31.RequestsRepo>(),
      ));
  gh.factory<_i52.SplashUseCase>(
      () => _i52.SplashUseCase(gh<_i42.BaseSplashRepo>()));
  gh.factory<_i53.SplashCubit>(
      () => _i53.SplashCubit(gh<_i52.SplashUseCase>()));
  return getIt;
}
