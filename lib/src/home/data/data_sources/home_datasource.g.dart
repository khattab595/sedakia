...
class _HomeDatasource implements HomeDatasource {
  ...
  Future<ApiResponse<SummaryDto>> fetchSummary() async {
    ...
    final _options = _setStreamType<ApiResponse<SummaryDto>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late ApiResponse<SummaryDto> _value;
    try {
      _value = ApiResponse<SummaryDto>.fromJson(
        _result.data!,
  ...
  Future<ApiResponse<List<MonthlyDto>>> fetchMonthly() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<List<MonthlyDto>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<List<MonthlyDto>> _value;
    try {
      _value = ApiResponse<List<MonthlyDto>>.fromJson(
        _result.data!,
