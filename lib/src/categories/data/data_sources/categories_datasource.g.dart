...
class _CategoriesDatasource implements CategoriesDatasource {
  ...
  @override
  Future<ApiResponse<List<CategoryDto>>> fetchCategories() async {
    ...
    final value = ApiResponse<List<CategoryDto>>.fromJson(
      _result.data!,
  ...
  @override
  Future<ApiResponse<List<ProductDto>>> fetchCategoryProduct(
    int id,
    int page,
  ) async {
    final _extra = <String, dynamic>{};
